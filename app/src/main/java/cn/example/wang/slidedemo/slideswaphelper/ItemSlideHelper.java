...
public class ItemSlideHelper extends RecyclerView.ItemDecoration
     ...
     */
    ItemSlideHelper.Callback mCallback;
     ...
     * {@link ItemSlideHelper.Callback#getAbsoluteMovementFlags(RecyclerView, RecyclerView.ViewHolder)} for the current
     * action state.
     */
    int mSelectedFlags;
     ...
     * jumpy UIs.
     */
    List<ItemSlideHelper.RecoverAnimation> mRecoverAnimations = new ArrayList<>();
    ...
    private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new RecyclerView.OnItemTouchListener() {
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                ...
                if (mSelected == null) {
                    final ItemSlideHelper.RecoverAnimation animation = findAnimation(event);
                    if (animation != null) {
     ...
     */
    public ItemSlideHelper(ItemSlideHelper.Callback callback) {
        mCallback = callback;
    }
    ...
    private void destroyCallbacks() {
        ...
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
            final ItemSlideHelper.RecoverAnimation recoverAnimation = mRecoverAnimations.get(0);
    ...
    private void initGestureDetector() {
        ...
        mGestureDetector = new GestureDetectorCompat(mRecyclerView.getContext(),
                new ItemSlideHelper.WItemTouchHelperPlusGestureListener());
    }
    ...
    private float getSwipeWidth() {
        return mCallback.getActionWidth(mSelected);
//        return mRecyclerView.getWidth();
    ...
    void select(RecyclerView.ViewHolder selected, int actionState) {
        ...
        if (mSelected != null) {
            ...
            if (prevSelected.itemView.getParent() != null) {
                ...
                final ItemSlideHelper.RecoverAnimation rv = new ItemSlideHelper.RecoverAnimation(prevSelected, animationType,
    ...
    void postDispatchSwipe(final ItemSlideHelper.RecoverAnimation anim, final int swipeDir) {
    ...
    int endRecoverAnimation(RecyclerView.ViewHolder viewHolder, boolean override) {
        final int recoverAnimSize = mRecoverAnimations.size();
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
            final ItemSlideHelper.RecoverAnimation anim = mRecoverAnimations.get(i);
    ...
    ItemSlideHelper.RecoverAnimation findAnimation(MotionEvent event) {
        ...
        if (Math.abs(mDx) > Math.abs(mDy)) {
            if ((swipeDir = checkHorizontalSwipe(viewHolder, flags)) > 0) {
                ...
                if ((originalFlags & swipeDir) == 0) {
                    // convert to relative
                    return ItemSlideHelper.Callback.convertToRelativeDirection(swipeDir,
                            ViewCompat.getLayoutDirection(mRecyclerView));
                }
                return swipeDir;
            }
    ...
    private int checkHorizontalSwipe(RecyclerView.ViewHolder viewHolder, int flags) {
        if ((flags & (LEFT | RIGHT)) != 0) {
            ...
            if (mCallback.getItemSlideType().equals(SLIDE_ITEM_TYPE_ITEMVIEW)) {

                width += mCallback.getActionWidth(viewHolder);
            }
     ...
     * {@link ItemSlideHelper.SimpleCallback}.
     * <p>
     * If user drags an item, WItemTouchHelperPlus will call
     * {@link ItemSlideHelper.Callback#onMove(RecyclerView, RecyclerView.ViewHolder, RecyclerView.ViewHolder)
    ...
    public abstract static class Callback {
        ...
        /**
         * Returns the {@link ItemTouchUIUtil} that is used by the {@link ItemSlideHelper.Callback} class for
         * visual
         ...
         * <p>
         * By default, {@link ItemSlideHelper.Callback} applies these changes on
         ...
         * </pre>
         *
         * @return The {@link ItemTouchUIUtil} instance that is used by the {@link ItemSlideHelper.Callback}
         */
        ...
        public abstract int getActionWidth(RecyclerView.ViewHolder viewHolder);
        ...
        public void onMoved(final RecyclerView recyclerView,
            ...
            if (layoutManager instanceof ItemSlideHelper.ViewDropHandler) {
                ((ItemSlideHelper.ViewDropHandler) layoutManager).prepareForDrop(viewHolder.itemView,
                        target.itemView, x, y);
                return;
            }
     ...
     * </pre>
     */
    public abstract static class SimpleCallback extends ItemSlideHelper.Callback {
